...
if [ -f "$SCRIPT_DIR/.mise.toml" ]; then
    if grep -q 'java = "lts"' "$SCRIPT_DIR/.mise.toml" && grep -q 'node = "lts"' "$SCRIPT_DIR/.mise.toml" && grep -q 'go = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'maven = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'python = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'neovim = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'eza = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'bat = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'btop = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'delta = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'duf = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'dust = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'hyperfine = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'jless = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'jq = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'lazygit = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'tealdeer = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'yq = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'glow = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'tree-sitter = "latest"' "$SCRIPT_DIR/.mise.toml" && grep -q 'go.set_gobin = false' "$SCRIPT_DIR/.mise.toml" && grep -q 'go.set_gopath = false' "$SCRIPT_DIR/.mise.toml"; then
