...
- **`zsh-syntax-highlighting`**: Authentic 24-bit TrueColor Solarized Dark command highlighting (commands in green `#859900`, options/strings in cyan `#2AA198`, variables in yellow `#B58900`, errors in red `#DC322F`).
