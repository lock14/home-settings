...
- **`zsh-syntax-highlighting`**: Authentic 24-bit TrueColor Solarized Dark command highlighting (commands in green `#859900`, options/variables/assignments in yellow `#B58900`, strings in cyan `#2AA198`, directories/paths in blue `#268BD2`, operators/redirections in violet `#6C71C4`, numbers in magenta `#D33682`, errors in red `#DC322F`).
