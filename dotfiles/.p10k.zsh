...
() {
  ...
  # Transparent background across all prompt segments (Lean Solarized Canvas).
  ...
  typeset -g POWERLEVEL9K_DIR_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%F{#268BD2}\uE0B1'
  ...
  typeset -g POWERLEVEL9K_VI_MODE_BACKGROUND=
  ...
  typeset -g POWERLEVEL9K_AZURE_BACKGROUND=
  # Custom icon.
